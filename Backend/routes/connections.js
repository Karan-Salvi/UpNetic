...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const existingConnection = await Connection.checkConnection(
      requesterId,
      userId
    );
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const mutualCount = await Connection.getMutualConnections(
      currentUserId,
      userId
    );
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const suggestions = await Connection.getSuggestions(
      userId,
      parseInt(limit)
    );
